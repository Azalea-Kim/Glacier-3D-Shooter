...
public class House {
    ...
    // Draw a Tent
    public void DrawHouse(float delta, int swingInt,Texture rock, Texture cube_texture, Texture flag,Texture ice, Texture space, boolean HouseStatus) {
        float LimbRotation;
...
//        DisplayListOval shadow = new DisplayListOval(20f,32);
//        glPushMatrix();
